...
public:
  sim_t(const char* isa, size_t _nprocs,  bool halted, reg_t start_pc,
        ...
        const std::vector<std::string>& args, const std::vector<int> hartids,const 	
	std::vector<std::string> tracked_insn,unsigned progsize, unsigned max_bus_master_bits, bool 
  ...
  void set_procs_track_insn(bool value);
