...
public:
  ...
  void set_track_insn(bool value);
  bool get_track_insn() { return track_insn;}
  void reset();
  ...
  void update_tracked_insn_count(const insn_t & insn);
  void set_tracked_insns(const std::vector<std::string> & );
...
private:
  ...
  std::unordered_map<std::string,uint64_t> tracked_insn_count;  
